...
class ClientSomthing {
    ...
    public ClientSomthing(String addr, int port) {
        ...
        this.port = port;
        try {
            this.socket = new Socket(addr, port);    //инициализируем объект типа сокет
        } catch (IOException e) {
        ...
        public void run() {
            ...
            try {
                while (true) {
                    ...
                    if (str.equals("stop")) {
                        ClientSomthing.this.downService(); // делит
        ...
        public void run() {
            while (true) {
                ...
                try {
                    ...
                    ClientSomthing.this.downService(); // в случае исключения тоже делит
